...
public partial class MstRecruitmentCandidate
{
    ...
    public virtual ICollection<MstCandidateApplicationForm1> MstCandidateApplicationForm1s { get; set; } = new List<MstCandidateApplicationForm1>();
