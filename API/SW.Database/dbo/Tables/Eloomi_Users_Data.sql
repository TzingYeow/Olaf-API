CREATE TABLE [dbo].[Eloomi_Users_Data] (
    [id]                     INT            NOT NULL,
    ...
    CONSTRAINT [PK_Eloomi_Users_Data] PRIMARY KEY CLUSTERED ([id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IX_EmployeeId]
    ON [dbo].[Eloomi_Users_Data]([employee_id] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_UserName]
    ON [dbo].[Eloomi_Users_Data]([username] ASC);
