...
-- Execution: Exec [SP_RPT_IndependentContractorList] 101/ "HK,ID,KR,MY,PH,TH,TW,SG"      
-- Exec [SP_RPT_IndependentContractorList] NULL,"SG","INACTIVE"   


-- =============================================       
CREATE PROCEDURE [dbo].[SP_RPT_IndependentContractorList]      
(      
 @MarketingCompanyId NVARCHAR(255) = NULL,      
 @CountryCode NVARCHAR(255) = NULL,
 @Status NVARCHAR(50) = NULL
)      
AS      
BEGIN  
--DECLARE @MarketingCompanyId NVARCHAR(255) = NULL;
--DECLARE @CountryCode NVARCHAR(255) = 'TW';
--DECLARE @Status NVARCHAR(50) = 'Suspend';
...
--IF OBJECT_ID('tempdb..#SubMarketingCompany') IS NOT NULL DROP TABLE #SubMarketingCompany
--SELECT CAST(VALUE as varchar) as 'MarketingCompanyID' INTO #SubMarketingCompany FROM STRING_SPLIT(@MarketingCompanyId, ',') 
...
IF @MarketingCompanyId != ''
BEGIN

	DELETE A
	FROM #TEMP_IndependentContractor A
	--LEFT OUTER JOIN #SubMarketingCompany B on A.MarketingCompanyId = B.MarketingCompanyID
...
-- Level
,c.IndependentContractorLevelId as newIClevel,c.LevelCode,c.Level,c.LevelOrdinal, A.SalesBranch -- into #TEMP_ICList
from #TEMP_IndependentContractor a
