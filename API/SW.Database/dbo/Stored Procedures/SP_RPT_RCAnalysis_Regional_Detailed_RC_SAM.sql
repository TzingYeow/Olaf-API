...
-- [SP_RPT_RCAnalysis_Regional_Detailed_RC_SAM] '2021-06-01','b2a2a1706a0d403598e9115d5846485d'
-- ==========================================================================================
CREATE PROCEDURE [dbo].[SP_RPT_RCAnalysis_Regional_Detailed_RC_SAM]
...
-- ================== Induction  ========================
		...
		SELECT Country, MCCode , 'Oct-22' Month, Description AS 'Recruitment Type', Recruiter, SUM(Total)Total  
		FROM #DETAILED WHERE WeDate <= @Maxdate 
		AND Description IN ('ORFirstAppointmentBooked','ORFirstAppointmentTurnedUp','PRFirstAppointmentBooked','PRFirstAppointmentTurnedUp')
		and Country IN ('HK','MY','SG','TW')
		GROUP BY Country, MCCode, Description, Recruiter
		order by Country asc, MCCode asc

		-- [SP_RPT_RCAnalysis_Regional_Detailed_RC_SAM] '2022-10-01','b2a2a1706a0d403598e9115d5846485d'
