 ...
 --SP_RPT_WeeklyHuddleReport_LEO '2024-04-28'
CREATE PROCEDURE [dbo].[SP_RPT_WeeklyHuddleReport_LEO]
	-- Add the parameters for the stored procedure here
	@ReportWE  date , @MOCCC NVARCHAR(2)
AS
BEGIN
...
LEFT JOIN NewOlaf_Prod..Mst_Campaign B ON B.CountryCode = 'KR' and A.Campaign = B.CampaignName collate SQL_Latin1_General_CP1_CI_AS
WHERE MOSubWE = @weDate and OfficeID <> 'HQ'  and PaidAmount > 0 and officeid = @MOCCC --and TimesSubmitted = 1
...
WHERE MOSubWE = @weDate and SubType is not null and B.Customer is null  and officeid = @MOCCC
...
from Appco360_PROD..Maintable  A 
LEFT JOIN NewOlaf_Prod..Mst_Campaign B ON B.CountryCode = 'KR' and A.Campaign = B.CampaignName collate SQL_Latin1_General_CP1_CI_AS
WHERE MORejectWE = @weDate  and OfficeID <> 'HQ'  and PaidAmount > 0  and officeid = @MOCCC and A.Campaign collate SQL_Latin1_General_CP1_CI_AS NOT IN (
...
WHERE MORejectWE = @weDate  and OfficeID <> 'HQ'  and PaidAmount > 0   and officeid = @MOCCC
