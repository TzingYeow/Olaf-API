...
-- =============================================
--EXEC SP_RPT_Adoption_OverviewRecruitmentMonthly
CREATE PROCEDURE [dbo].[SP_RPT_Adoption_OverviewRecruitmentMonthly] 
...
BEGIN
	...
	(SELECT CONVERT(nvarchar(3), WEDate,109) + '-' + CONVERT(nvarchar(2), WEDate,102) as 'WeDate' , SUM(TotalMCActive) / COUNT(*) as 'AvgMCActive', SUM(TotalMC) / COUNT(*)  as 'AvgMc'
	FROM RPT_OverviewRecruitment
