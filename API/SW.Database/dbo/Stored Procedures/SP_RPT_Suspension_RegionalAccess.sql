...
-- EXEC [SP_RPT_Suspension_RegionalAccess] '2023-01-08','2023-01-08','b2a2a1706a0d403598e9115d5846485d'-- REGIONAL
-- =============================================
CREATE PROCEDURE [dbo].[SP_RPT_Suspension_RegionalAccess]
	 @weFromDate Date,
	 @weToDate Date,
	 @userId NVARCHAR(255)
...
WHERE A.Country = 'HK' and A.SignUpPieces > 0 and A.Campaign in ('Viospace','Home Cuisine') and IsDeleted = 0 AND A.wedate IN ( '2023-01-08' , '2023-01-08')
-- HONG KONG (END)
...
SELECT * FROM #FinalReport A WHERE A.CountryCode IN (SELECT Country FROM #SubCountry)
