CREATE PROCEDURE [dbo].[sp_Job_Send_PR_Wednesday]
...
BEGIN
	...
	--ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>amitaa.k@salesworks.asia;shaun.tan@salesworks.asia;vicky.veeravijayan@salesworks.asia;beckham.chng@salesworks.asia;MYS_RegOps@salesworks.asia;ops.my.lifestyle@salesworks.asia;mys_takaful@salesworks.asia</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.&lt;br&gt;&lt;br&gt;</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
	...
	--ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>francesca.khor@salesworks.asia;simone.lai@salesworks.asia;amitaa.k@salesworks.asia</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.&lt;br&gt;&lt;br&gt;</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
	--WHERE SubscriptionID = @ReportGUID
 ...
 --   UPDATE ReportServer..Subscriptions SET
	...
	--ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>hubs@appcogroup.asia;my.accounts@salesworks.asia</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.&lt;br&gt;&lt;br&gt;</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
	--WHERE SubscriptionID = @ReportGUID
	----REMOVE TW
	...
	ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>tw.accounts@salesworks.asia</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.&lt;br&gt;&lt;br&gt;</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
	WHERE SubscriptionID = @ReportGUID
	...
	ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>choi.li@salesworks.asia;adilla.aziz@salesworks.asia;farhah.isammudin@salesworks.asia;Terrence.tey@salesworks.asia;Terrence@infinityorg.asia;susien.kong@salesworks.asia;shanyung.mok@salesworks.asia;bettaney.teo@salesworks.asia;</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.&lt;br&gt;&lt;br&gt;</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
	WHERE SubscriptionID = @ReportGUID
	...
	--	 WHERE B.Code not in ('NA') and ISNULL(A.Email ,'') not in (
	--	 'NOTApplicable@na.com','123@salesworks.asia','na@na.com','test@sw.my','xxx@ma.com','appco@appcogroup.asia')
	...
	--	 and ISNULL(A.Email ,'') not in ('123@salesworks.asia','123@gmail.com','123@saleswork.asia')  and ISNULL(A.Email ,'') <> ''
	--	 )A
	--	 ) A

	--	UPDATE ReportServer..Subscriptions SET
	--	Parameters = '<ParameterValues><ParameterValue><Name>ShowAccount</Name><Value>N</Value></ParameterValue><ParameterValue><Name>MCCode</Name><Value></Value></ParameterValue><ParameterValue><Name>CountryCode</Name><Value>MY</Value></ParameterValue><ParameterValue><Name>WeDate</Name><Value>' + FORMAT(@WEDate,'M/d/yyyy') + ' 12:00:00 AM</Value></ParameterValue></ParameterValues>', --<ParameterValues><ParameterValue><Name>Owner</Name><Value>All</Value></ParameterValue><ParameterValue><Name>WEDate</Name><Value>' + FORMAT(@WEDate,'M/d/yyyy') + ' 12:00:00 AM</Value></ParameterValue></ParameterValues>',
	--	ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>'+@ALLOWnerAndAdmin+'</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.&lt;br&gt;&lt;br&gt;</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
	--	WHERE SubscriptionID = @ReportGUID
	...
	--	waitfor delay '00:00:30'
  	...
  	-- SENT ALL TW Owner & Admin
		DECLARE @ALLOWnerAndAdminTW NVARCHAR(MAX)
		SELECT @ALLOWnerAndAdminTW =  STRING_AGG(Email,';') FROM (
		SELECT STRING_AGG(Email,';') as Email FROM (
		 SELECT distinct A.email FROM Mst_MarketingCompany_Staff A LEFT JOIN Mst_MarketingCompany B ON A.MarketingCompanyId = B.MarketingCompanyId
		 WHERE B.Code not in ('NA') and ISNULL(A.Email ,'') not in (
		 'NOTApplicable@na.com','123@salesworks.asia','na@na.com','test@sw.my','xxx@ma.com','appco@appcogroup.asia')
		...
		UPDATE ReportServer..Subscriptions SET
		Parameters = '<ParameterValues><ParameterValue><Name>ShowAccount</Name><Value>N</Value></ParameterValue><ParameterValue><Name>MCCode</Name><Value></Value></ParameterValue><ParameterValue><Name>CountryCode</Name><Value>TW</Value></ParameterValue><ParameterValue><Name>WeDate</Name><Value>' + FORMAT(@WEDate,'M/d/yyyy') + ' 12:00:00 AM</Value></ParameterValue></ParameterValues>', --<ParameterValues><ParameterValue><Name>Owner</Name><Value>All</Value></ParameterValue><ParameterValue><Name>WEDate</Name><Value>' + FORMAT(@WEDate,'M/d/yyyy') + ' 12:00:00 AM</Value></ParameterValue></ParameterValues>',
		ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>'+@ALLOWnerAndAdminTW+'</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.&lt;br&gt;&lt;br&gt;</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
		WHERE SubscriptionID = @ReportGUID
	...
	--	UPDATE ReportServer..Subscriptions SET
	--	Parameters = '<ParameterValues><ParameterValue><Name>ShowAccount</Name><Value>N</Value></ParameterValue><ParameterValue><Name>MCCode</Name><Value></Value></ParameterValue><ParameterValue><Name>CountryCode</Name><Value>SG</Value></ParameterValue><ParameterValue><Name>WeDate</Name><Value>' + FORMAT(@WEDate,'M/d/yyyy') + ' 12:00:00 AM</Value></ParameterValue></ParameterValues>', --<ParameterValues><ParameterValue><Name>Owner</Name><Value>All</Value></ParameterValue><ParameterValue><Name>WEDate</Name><Value>' + FORMAT(@WEDate,'M/d/yyyy') + ' 12:00:00 AM</Value></ParameterValue></ParameterValues>',
	--	ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>'+@ALLOWnerAndAdminSG+'</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.&lt;br&gt;&lt;br&gt;</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
	--	WHERE SubscriptionID = @ReportGUID
	...
	-- SENT ALL Individual MC and Admin
		...
		--ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>hubs@appcogroup.asia</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File. ['+@LoopMC+'] : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
		--WHERE SubscriptionID = @ReportGUID
		...
		UPDATE ReportServer..Subscriptions SET
		Parameters = '<ParameterValues><ParameterValue><Name>ShowAccount</Name><Value>N</Value></ParameterValue><ParameterValue><Name>MCCode</Name><Value>'+@LoopMC+'</Value></ParameterValue><ParameterValue><Name>CountryCode</Name><Value>'+@LoopCountry+'</Value></ParameterValue><ParameterValue><Name>WeDate</Name><Value>' + FORMAT(@WEDate,'M/d/yyyy') + ' 12:00:00 AM</Value></ParameterValue></ParameterValues>', --<ParameterValues><ParameterValue><Name>Owner</Name><Value>All</Value></ParameterValue><ParameterValue><Name>WEDate</Name><Value>' + FORMAT(@WEDate,'M/d/yyyy') + ' 12:00:00 AM</Value></ParameterValue></ParameterValues>',
		ExtensionSettings = '<ParameterValues><ParameterValue><Name>TO</Name><Value>'+@OwnerandAdmin+'</Value></ParameterValue><ParameterValue><Name>CC</Name><Value>adilla.aziz@salesworks.asia;leonard.yong@salesworks.asia</Value></ParameterValue><ParameterValue><Name>IncludeReport</Name><Value>True</Value></ParameterValue><ParameterValue><Name>RenderFormat</Name><Value>EXCELOPENXML</Value></ParameterValue><ParameterValue><Name>Subject</Name><Value>PR Incentives Weekly File : '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'</Value></ParameterValue><ParameterValue><Name>Comment</Name><Value>Hi Everyone,&lt;br&gt;  Kindly see attached PR Incentives Report for '+'WE' + FORMAT(@WEDate,'ddMMyyyy') +'.&lt;br&gt; Thank you.</Value></ParameterValue><ParameterValue><Name>IncludeLink</Name><Value>False</Value></ParameterValue><ParameterValue><Name>Priority</Name><Value>NORMAL</Value></ParameterValue></ParameterValues>'
		WHERE SubscriptionID = @ReportGUID
