...
-- =============================================
--EXEC SP_RPT_Adoption_OverviewDigitalAppNewMonthly
CREATE PROCEDURE [dbo].[SP_RPT_Adoption_OverviewDigitalAppNewMonthly] 
...
BEGIN
	...
	(SELECT CONVERT(nvarchar(3), WEDate,109) + '-' + CONVERT(nvarchar(2), WEDate,102) as 'WeDate' , SUM(TotalSubmitted) as 'AvgMCActive', SUM(TotalFirstAppointment)  as 'AvgMc'
	...
	SELECT * FROM #TempRaw where WEDate not in ('Jan-20','Feb-20','Mar-20')
	order by WEOrder
