--EXEC SP_AutoAdvancement_DataPull_MY '2023-08-27'
--=============================
CREATE PROCEDURE [dbo].[SP_AutoAdvancement_DataPull_MY] 
	@WEDate DATE
AS
BEGIN
...
BadgeNoLink,DirectReportBadgeNo,LevelPromotionDate,NetPoint,NetValue,SubPcs,CreatedDate,IsDeleted)
 ...
 SELECT  @Weekending,'MY',A.MCCode, A.IndependentContractorId, A.BadgeNo, ISNULL(E.levelCode, D.LevelCode),ISNULL(G.LevelCode,ISNULL(E.levelCode, D.levelCode)), F.BadgeNolink, F.DirectReportBadgeNumber,
 ISNULL(C.EffectiveDate, A.EffectiveAdvancementDate), 0.00, B.TotalPayable, PersonalSalesPieces ,@CDate, 0 FROM #ActiveBA A 
