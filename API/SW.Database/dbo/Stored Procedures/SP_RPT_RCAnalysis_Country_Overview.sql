...
-- Description:	Country Access RC Analysis Report 
-- EXEC SP_RPT_RCAnalysis_Country_Overview '2021-06-01','b2a2a1706a0d403598e9115d5846485d'
-- =============================================
CREATE PROCEDURE [dbo].[SP_RPT_RCAnalysis_Country_Overview]
...
-- ================== TotalInactiveLeader  =================
		...
		WHERE Description IN ('Deactivate','Deactivated','Terminate') AND IndependentContractorLevelId= '4' 
		AND Coalesce(LeavingReasonCategory, '') <> 'TRANSFER'
		and IsDeleted = 0
