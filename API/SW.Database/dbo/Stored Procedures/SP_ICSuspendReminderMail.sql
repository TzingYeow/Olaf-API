...
-- =============================================
CREATE PROCEDURE [dbo].[SP_ICSuspendReminderMail]  
	...
	SET NOCOUNT ON;
	 DECLARE @SUSPENSIONRUNDATE DATE;
		...
		--To fix issue second suspension within 180days/6months from first suspension
			...
			where C.IndependentContractorId NOT IN (SELECT IndependentContractorId from #Suspension21Daywithin180Day) AND CountryCode NOT IN ('SG')
