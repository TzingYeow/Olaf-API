...
-- Description:	To retrieve Singapore BA Records (Master Data)
-- EXEC SP_SGBARecordsMaster
-- ===========================================================
CREATE PROCEDURE [dbo].[SP_SGBARecordsMaster]
...
BEGIN
	...
	WHERE B.CountryCode = 'SG' AND B.IsActive = 1
