...
-- EXEC SP_RPT_IndependentContractorList_OtherAccess 'ba608c0d064243d88450d8c948e4df40','Active,Inactive' -- MO ADMIN
-- =============================================       
CREATE PROCEDURE [dbo].[SP_RPT_IndependentContractorList_OtherAccess]      
(           
