--EXEC SP_RPT_TeamPerformanceTracking_WeDate2 '2023-08-06'
--=============================
CREATE PROCEDURE [dbo].[SP_RPT_TeamPerformanceTracking_WeDate2]
	@WEDate DATE
AS
BEGIN
...
union ALL
 ...
 SELECT * FROM #CharityRawData WHERE MOCode = 'AR'
...
GROUP BY OfficeId
 ...
 SELECT * FROM #TKFRawData WHERE MOCode = 'AR'
