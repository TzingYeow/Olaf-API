...
-- =============================================       
CREATE PROCEDURE [dbo].[SP_RPT_IndependentContractorList_Regional]      
(           
...
--UPDATE #TEMP_IndependentContractor SET BranchId = MarketingCompanyBranchId WHERE IndependentContractorId NOT IN (SELECT IndependentContractorId FROM #BRANCH) AND SalesBranch IS NOT NULL
