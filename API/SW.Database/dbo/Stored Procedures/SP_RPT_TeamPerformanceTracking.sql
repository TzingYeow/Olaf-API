...
--=============================
CREATE PROCEDURE [dbo].[SP_RPT_TeamPerformanceTracking]
...
BEGIN
 ...
 SELECT TOP 1 * FROM NewMYDB_PROD..Tbl_Weekending WHERE WEdate <= GETDATE() ORDER BY WEdate desc
 ) B ORDER BY B.WEdate ASC)
 
 --SET @Weekending = '2022-02-13'
