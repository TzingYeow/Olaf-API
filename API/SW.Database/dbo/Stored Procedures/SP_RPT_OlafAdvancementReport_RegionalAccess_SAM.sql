...
-- EXEC [SP_RPT_OlafAdvancementReport_RegionalAccess_SAM] '2023-01-01','2023-12-03','b2a2a1706a0d403598e9115d5846485d','KR'

-- =============================================
CREATE PROCEDURE [dbo].[SP_RPT_OlafAdvancementReport_RegionalAccess_SAM]
 	 @FromDate Date,
	 @ToDate Date,
	 @userId NVARCHAR(255),
...
SELECT @SFROMDATE,@STODATE
SELECT * FROM #Temp where BadgeNo = 'OP00001'
